-- Make sale creation RPC use catalog data supplied by the backend cache.
-- The RPC no longer SELECTs/JOINs product_names/product_variants while creating a sale.
